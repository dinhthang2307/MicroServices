...
class InvoiceFormPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            billToEmail: "",
            billToAddress: "",
            billFrom: "vu dinh thang",
            billFromEmail: "dinhthang2307@gmail.com",
            billFromAddress: "thanh pho Ho Chi Minh",
            notes: "",
            total: 0.0,
            subTotal: 0.0,
            taxRate: 10.0,
  ...
  handleAutoFillItems(){
    ...
    var deletedItem = this.state.items.pop() 
    if(!cart){return}
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <Form.Group className="mb-3">
              ...
              >
                <option value="đ">VND (Viet nam dong)</option>
...
export default connect(mapStateToProps)(InvoiceFormPage);